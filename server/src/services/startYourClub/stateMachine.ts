...
const TRANSITIONS: Record<string, ClubApplicationStatus[]> = {
  ...
  ON_HOLD: ['INTERVIEW_PENDING', 'INTERVIEW_SCHEDULED', 'REJECTED'],
  INTERVIEW_PENDING: ['INTERVIEW_SCHEDULED', 'ON_HOLD'],
  INTERVIEW_SCHEDULED: ['INTERVIEW_DONE', 'INTERVIEW_PENDING', 'ON_HOLD'],
